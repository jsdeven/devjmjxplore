{strip}{if !empty($ab__lc_landing_categories)}
    ...
    <div class="row-fluid{if $settings.Appearance.columns_in_products_list =="5"} v-col{elseif $settings.Appearance.columns_in_products_list =="4"} f-col{elseif $settings.Appearance.columns_in_products_list =="3"} t-col{/if}">
