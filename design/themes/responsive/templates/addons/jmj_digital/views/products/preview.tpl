...
<script>
    $(document).ready(function(){
        ...
        $(".ty-btn__add-to-cart").prop('disabled', true);
        $('.ty-cr-product-button').removeClass("cm-dialog-opener");
        $('.ut2-add-to-wish').removeClass("cm-submit");
        $('.ut2-add-to-compare').removeClass("cm-ajax");
        $("a").removeAttr("href");
    });
</script>    