...
<tr>
{hook name="ab__video_gallery:videos_list_body"}
<td width="2%">
<span id="on_ab__vg_video_extra_{$_key}" title="{__("expand_collapse_list")}" class="hand hidden cm-combination-video_extra"><span class="exicon-expand"></span></span>
<span id="off_ab__vg_video_extra_{$_key}" title="{__("expand_collapse_list")}" class="hand cm-combination-video_extra"><span class="exicon-collapse"></span></span>
</td>
...
<tr class="cr-table-detail {$no_hide_input_if_shared_product}" id="ab__vg_video_extra_{$_key}">
<td colspan="6">
<div class="control-group">
...
{hook name="ab__video_gallery:videos_list_clone"}
<td width="2%">
