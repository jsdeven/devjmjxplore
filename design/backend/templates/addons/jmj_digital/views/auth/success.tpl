	...
	<div class="ty-mainbox-container clearfix"> 
		<div class="ty-mainbox-body">
			<div class="ty-account">
              <div class="sellerhub-forms-thanks">
                <h2>It’s a succes!</h2>
                <p>You have successfully completed your registration with us.</p>
                <p>We will be sending a confirmation response  to your registered email ID stating officially agreed or accepted as satisfactory.</p>
                <div class="mt-3"><a href="https://jmjxplore.com/seller/" class="backtohome">BACK TO HOMEPAGE</a></div>
            </div>
          </div>
        </div>
      </div>
