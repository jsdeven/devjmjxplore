...
(function(_, $) {
    ...
    _.tr({
        ...
        file_invalid_dimensions: '{__("file_invalid_dimensions")|escape:"javascript"}',
...
{if $jmj_validation}
    {script src="js/addons/jmj_digital/fileuploader_scripts.js"}
{else}
    {script src="js/tygh/fileuploader_scripts.js"}
{/if}
{script src="js/tygh/node_cloning.js"}
{assign var="prefix" value=10|mt_rand:1000}
{assign var="prefix_pro" value=10|mt_rand:1000}
{assign var="id_var_name" value="`$prefix``$prefix_pro`{$var_name|md5}"}
