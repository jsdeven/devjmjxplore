...
{assign var="jmj_validation" value=$jmj_validation|default:true}
...
<div id="box_attach_images_{$name}_{$key}" class="attach-images">
    {if $jmj_validation}
        <span class="desc">{__("max_size_and_pixel")}</span>
    {/if}    
    ...
    <div class="upload-box clearfix {if $no_thumbnail && !$pair.icon}hidden{/if}" id="load_thumbnail_{$name}{$suffix}{$key}">
        ...
        <div class="image-upload cm-hide-with-inputs">
            {include file="addons/jmj_digital/views/common/fileuploader.tpl" var_name="`$name`_image_icon`$suffix`[`$key`]" is_image=true jmj_validation="$jmj_validation"}
    ...
    <div class="upload-box clearfix">
        ...
        <div class="image-upload cm-hide-with-inputs">
            {include file="addons/jmj_digital/views/common/fileuploader.tpl" var_name="`$name`_image_detailed`$suffix`[`$key`]" is_image=true jmj_validation="$jmj_validation"}
