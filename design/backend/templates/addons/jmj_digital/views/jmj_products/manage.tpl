                ...
                >
                    ...
                    <td class="products-list__image">
                        {include 
                                ...
                                href="products.add?product_id=`$product.product_id`"|fn_url
                    ...
                    <td class="product-name-column wrap-word" data-th="{__("name")}">
                        ...
                        <a class="row-status" href="{"products.add?product_id=`$product.product_id`"|fn_url}">{$product.product nofilter}</a>
                        ...
                        <div class="hidden-tools">
                            {capture name="tools_list"}
                                {hook name="products:list_extra_links"}
                                    <li>{btn type="list" text=__("edit") href="products.add?product_id=`$product.product_id`"}</li>
                                    {if !$hide_inputs_if_shared_product}
                                        ...
                                        <li>{btn
                                            ...
                                            text=__("Preview")
                                            target="_blank"
                                            href="index.php?dispatch=products.preview&product_id=`$product.product_id`"}
                                    </li>
                                    {/if}
                                {/hook}
                            {/capture}
