...
<div class="control-group">
<label class="control-label" for="ab__stickers_name_for_desktop">{__("ab__stickers.name_for_desktop")}{include file="common/tooltip.tpl" tooltip=__('ab__stickers.name_for_desktop.tooltip')}:</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="ab__stickers_name_for_mobile">{__("ab__stickers.name_for_mobile")}{include file="common/tooltip.tpl" tooltip=__('ab__stickers.name_for_mobile.tooltip')}:</label>
<div class="controls">
...
<label class="control-label" for="ab__stickers_use_theme_presets">{__("ab__stickers.use_theme_presets")}{include file="common/tooltip.tpl" tooltip=__("ab__stickers.use_theme_presets.tooltip", ["[href]" => $href])}:</label>
<div class="controls">
...
{foreach ['16', '24', '32', '48', '64'] as $image_size}
...
<div class="control-group">
<label class="control-label" for="ab__stickers_sticker_description">{__("ab__stickers.description")}{include file="common/tooltip.tpl" tooltip=__("ab__stickers.description.tooltip")}:</label>
<div class="controls">
