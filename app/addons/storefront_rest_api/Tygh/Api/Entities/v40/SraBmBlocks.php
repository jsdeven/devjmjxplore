        ...
        foreach ($grids as $container_id => $items) {
            foreach ($items as $grid_id => $grid) {
                ...
                foreach ($blocks[$grid_id] as $block_id => $block) {
                    ...
                    /* custom code done add by ram dhakrey start */
                    $block['content']['user_id'] = $params['user_id'];
                    $block['content']['user_type'] = $params['user_type'];
                    /* custom code done add by ram dhakrey end */
